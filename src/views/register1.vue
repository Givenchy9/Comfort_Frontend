<template>
  <form @submit.prevent="submitForm" class="grid grid-cols-2 w-1/2 m-8 mt-40 m-auto gap-4">
    ...
    <RouterLink to="/" class="col-span-2 font-bold float-right text-center hover:text-blue-600 hover:underline">
      Wil je naar de hoofdscherm? Klik hier
    </RouterLink>
