<template>
    <div>
      <div class="fixed bg-blue-500 top-0 left-0 right-0 grid grid-cols-3 py-2 items-center px-4 z-10 dark:bg-gray-800">
        <div class="flex items-center justify-start">
          <router-link to="/complete" class="inline-block mr-2">
            <img src="/favicon.ico" alt="favicon" class="w-6 h-6" />
          </router-link>
          <dropdown3 class="hidden sm:inline-block" />
        ...
        <div class="flex items-center justify-end space-x-1">
          ...
          <router-link to="/settings2" class="block p-2 text-gray-900 hover:bg-gray-100">Settings2</router-link>
          </div>
        </div>
      </div>
